package com.gdsc.foodsaver.global.common;
...
public enum ResponseCode {
    ...
    TOKEN_PREFIX_VALUE_EXCEPTION(HttpStatus.BAD_REQUEST, "TOKEN4002", "토큰 prefix값이 잘못되었습니다 [google_]"),
    BEARER_PREFIX_VALUE_EXCEPTION(HttpStatus.BAD_REQUEST, "TOKEN4002", "토큰 prefix값이 잘못되었습니다 [Bearer ]"),

    //Recipe Error
    RECIPE_NOT_FOUND(HttpStatus.NOT_FOUND, "RECIPE4001", "해당 레시피가 없습니다");
